...
root_router = APIRouter(tags=["Index"])
...
<body>
  <article class="markdown-body"><h1 class="atx" id="welcome-to-file-server-api">Welcome to File Server API</h1>
<p>This API provides basic upload and download operations for files. </p>
<h2 class="atx" id="api-info">API info</h2>
<p><kbd><a href="/docs">/docs</a></kbd> to view API usage instructions and model information written using SwaggerUI</p>
<h2 class="atx" id="license">License</h2>
<p>Apache2.0</p>
<h2 class="atx" id="contact">Contact</h2>
<p>email: <a href="mailto:phil616@163.com">phil616@163.com</a></p>
<p>author: CCUACM</p>
<p>developer: phil616</p>
</article>
</body>
</html>
        """
